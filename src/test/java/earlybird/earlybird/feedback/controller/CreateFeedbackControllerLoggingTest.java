...
public class CreateFeedbackControllerLoggingTest {
    ...
    @Autowired private CreateFeedbackController controller;

    @Autowired private FeedbackCommentRepository commentRepository;

    @Autowired private FeedbackScoreRepository scoreRepository;

    @Autowired private PaymentFeedbackRepository paymentRepository;

    @Autowired private FeedbackScoreDayInfoRepository scoreDayInfoRepository;
    ...
    void noLoggingWithTestClientId() {
        CreateFeedbackCommentRequest commentRequest =
                CreateFeedbackCommentRequest.builder()
                        .clientId("test-id")
                        .comment("comment")
        ...
        CreateFeedbackScoreRequest scoreRequest =
                CreateFeedbackScoreRequest.builder()
                        .clientId("test-id")
                        .createdAt(LocalDateTime.of(2025, 3, 25, 0, 0, 0))
                        .score(10)
                        .dayCount(3)
        ...
        CreatePaymentFeedbackRequest paymentRequest =
