...
public interface EmailPromotionAddressDomainRepository extends JpaRepository<EmailPromotionAddressDomain, Long> {
    ...
    List<EmailPromotionAddressDomain> findAllByPromotionCampaign(PromotionCampaign promotionCampaign);
    Boolean existsByDomainNameAndPromotionCampaign(String domainName, PromotionCampaign promotionCampaign);
}
